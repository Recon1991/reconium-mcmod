...
public class ModBlocks {
    ...
    //public static final RegistryObject<Block> END_MOONSTONE_ORE = createAndRegisterEndGemOre("moonstone");

    public static final RegistryObject<Block> GREY_QUARTZ_ORE = createAndRegisterGemOre("grey_quartz");
    public static final RegistryObject<Block> DEEPSLATE_GREY_QUARTZ_ORE = createAndRegisterDeepslateGemOre("grey_quartz");
    //public static final RegistryObject<Block> NETHER_GREY_QUARTZ_ORE = createAndRegisterNetherGemOre("grey_quartz");
    //public static final RegistryObject<Block> END_GREY_QUARTZ_ORE = createAndRegisterEndGemOre("grey_quartz");

    public static final RegistryObject<Block> HEMATITE_ORE = createAndRegisterGemOre("hematite");
    public static final RegistryObject<Block> DEEPSLATE_HEMATITE_ORE = createAndRegisterDeepslateGemOre("hematite");
    //public static final RegistryObject<Block> NETHER_HEMATITE_ORE = createAndRegisterNetherGemOre("hematite");
    //public static final RegistryObject<Block> END_HEMATITE_ORE = createAndRegisterEndGemOre("hematite");

    //public static final RegistryObject<Block> ONYX_ORE = createAndRegisterGemOre("onyx");
    //public static final RegistryObject<Block> DEEPSLATE_ONYX_ORE = createAndRegisterDeepslateGemOre("onyx");
    public static final RegistryObject<Block> NETHER_ONYX_ORE = createAndRegisterNetherGemOre("onyx");
    //public static final RegistryObject<Block> END_ONYX_ORE = createAndRegisterEndGemOre("onyx");

    public static final RegistryObject<Block> ZIRCON_ORE = createAndRegisterGemOre("zircon");
    public static final RegistryObject<Block> DEEPSLATE_ZIRCON_ORE = createAndRegisterDeepslateGemOre("zircon");
    //public static final RegistryObject<Block> NETHER_ZIRCON_ORE = createAndRegisterNetherGemOre("zircon");
    //public static final RegistryObject<Block> END_ZIRCON_ORE = createAndRegisterEndGemOre("zircon");

    public static final RegistryObject<Block> RUBY_ORE = createAndRegisterGemOre("ruby");
    public static final RegistryObject<Block> DEEPSLATE_RUBY_ORE = createAndRegisterDeepslateGemOre("ruby");
    //public static final RegistryObject<Block> NETHER_RUBY_ORE = createAndRegisterNetherGemOre("ruby");
    //public static final RegistryObject<Block> END_RUBY_ORE = createAndRegisterEndGemOre("ruby");

    public static final RegistryObject<Block> TOPAZ_ORE = createAndRegisterGemOre("topaz");
    public static final RegistryObject<Block> DEEPSLATE_TOPAZ_ORE = createAndRegisterDeepslateGemOre("topaz");
    //public static final RegistryObject<Block> NETHER_TOPAZ_ORE = createAndRegisterNetherGemOre("topaz");
    //public static final RegistryObject<Block> END_TOPAZ_ORE = createAndRegisterEndGemOre("topaz");

    public static final RegistryObject<Block> CITRINE_ORE = createAndRegisterGemOre("citrine");
    public static final RegistryObject<Block> DEEPSLATE_CITRINE_ORE = createAndRegisterDeepslateGemOre("citrine");
    //public static final RegistryObject<Block> NETHER_CITRINE_ORE = createAndRegisterNetherGemOre("citrine");
    //public static final RegistryObject<Block> END_CITRINE_ORE = createAndRegisterEndGemOre("citrine");

    public static final RegistryObject<Block> PERIDOT_ORE = createAndRegisterGemOre("peridot");
    public static final RegistryObject<Block> DEEPSLATE_PERIDOT_ORE = createAndRegisterDeepslateGemOre("peridot");
    //public static final RegistryObject<Block> NETHER_PERIDOT_ORE = createAndRegisterNetherGemOre("peridot");
    //public static final RegistryObject<Block> END_PERIDOT_ORE = createAndRegisterEndGemOre("peridot");

    public static final RegistryObject<Block> JADE_ORE = createAndRegisterGemOre("jade");
    public static final RegistryObject<Block> DEEPSLATE_JADE_ORE = createAndRegisterDeepslateGemOre("jade");
    //public static final RegistryObject<Block> NETHER_JADE_ORE = createAndRegisterNetherGemOre("jade");
    //public static final RegistryObject<Block> END_JADE_ORE = createAndRegisterEndGemOre("jade");

    public static final RegistryObject<Block> TURQUOISE_ORE = createAndRegisterGemOre("turquoise");
    public static final RegistryObject<Block> DEEPSLATE_TURQUOISE_ORE = createAndRegisterDeepslateGemOre("turquoise");
    //public static final RegistryObject<Block> NETHER_TURQUOISE_ORE = createAndRegisterNetherGemOre("turquoise");
    //public static final RegistryObject<Block> END_TURQUOISE_ORE = createAndRegisterEndGemOre("turquoise");

    public static final RegistryObject<Block> LARIMAR_ORE = createAndRegisterGemOre("larimar");
    public static final RegistryObject<Block> DEEPSLATE_LARIMAR_ORE = createAndRegisterDeepslateGemOre("larimar");
    //public static final RegistryObject<Block> NETHER_LARIMAR_ORE = createAndRegisterNetherGemOre("larimar");
    //public static final RegistryObject<Block> END_LARIMAR_ORE = createAndRegisterEndGemOre("larimar");

    public static final RegistryObject<Block> SAPPHIRE_ORE = createAndRegisterGemOre("sapphire");
    public static final RegistryObject<Block> DEEPSLATE_SAPPHIRE_ORE = createAndRegisterDeepslateGemOre("sapphire");
    //public static final RegistryObject<Block> NETHER_SAPPHIRE_ORE = createAndRegisterNetherGemOre("sapphire");
    //public static final RegistryObject<Block> END_SAPPHIRE_ORE = createAndRegisterEndGemOre("sapphire");

    //public static final RegistryObject<Block> SUGILITE_ORE = createAndRegisterGemOre("sugilite");
    //public static final RegistryObject<Block> DEEPSLATE_SUGILITE_ORE = createAndRegisterDeepslateGemOre("sugilite");
    //public static final RegistryObject<Block> NETHER_SUGILITE_ORE = createAndRegisterNetherGemOre("sugilite");
    public static final RegistryObject<Block> END_SUGILITE_ORE = createAndRegisterEndGemOre("sugilite");

    //public static final RegistryObject<Block> SPINEL_ORE = createAndRegisterGemOre("spinel");
    //public static final RegistryObject<Block> DEEPSLATE_SPINEL_ORE = createAndRegisterDeepslateGemOre("spinel");
    //public static final RegistryObject<Block> NETHER_SPINEL_ORE = createAndRegisterNetherGemOre("spinel");
    public static final RegistryObject<Block> END_SPINEL_ORE = createAndRegisterEndGemOre("spinel");

    public static final RegistryObject<Block> PINK_DIAMOND_ORE = createAndRegisterGemOre("pink_diamond");
    public static final RegistryObject<Block> DEEPSLATE_PINK_DIAMOND_ORE = createAndRegisterDeepslateGemOre("pink_diamond");
    //public static final RegistryObject<Block> NETHER_PINK_DIAMOND_ORE = createAndRegisterNetherGemOre("pink_diamond");
    //public static final RegistryObject<Block> END_PINK_DIAMOND_ORE = createAndRegisterEndGemOre("pink_diamond");

    public static final RegistryObject<Block> SERAPHINITE_ORE = createAndRegisterGemOre("seraphinite");
    ...
    public static final RegistryObject<Block> MOONSTONE_FLOWER = registerBlock("moonstone_flower",
